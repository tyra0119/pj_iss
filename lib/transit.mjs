...
export class Transit {
  ...
  route(fromList, toSet) {
    ...
    for (let k = 1; k < path.length; k++) {
      ...
      if (e.mode === 'walk') { legs.push({ type: 'transfer', from: a, to: b, min: e.min }); continue; }
      if (e.mode === 'rail') {
...
export async function loadTransit(url = './data/transit.json?v=9fceb7f-1004', busUrl = './data/bus.json') {
